...
bool entry_handler_add(struct entry_handler_t *eh, struct entry *entry) __nonnull((1,2));
bool entry_handler_remove_all(struct entry_handler_t *eh, struct entry_array *out) __nonnull((1));
